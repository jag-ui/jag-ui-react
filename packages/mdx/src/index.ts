...
export type StyledComponentName = keyof IntrinsicSxElements | keyof JSX.IntrinsicElements;

const alias = (n: StyledComponentName): keyof JSX.IntrinsicElements => (isAlias(n) ? aliases[n] : n);
...
export type WithPoorAsProp<Props, As extends ElementType | undefined = undefined> = {
  as?: As;
...
type StyledDiv = StyledComponent<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, ThemedProps, Theme>;

export const Styled: StyledDiv & StyledComponentsDict = styled("div")(themed("div")) as StyledDiv &
  StyledComponentsDict;
