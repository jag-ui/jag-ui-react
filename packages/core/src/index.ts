import { jsx as emotion, ThemeContext as EmotionContext, InterpolationWithTheme } from "@emotion/core";
 ...
 * Deeply merge themes
 */
export const merge = (a: Theme, b: Theme): Theme => deepmerge(a, b, { isMergeableObject, arrayMerge });
