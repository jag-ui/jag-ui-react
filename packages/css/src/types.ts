...
interface AliasesCSSProperties {
   ...
   *
   * @see https://jag-ui.com/sx-prop#theme-aware-properties
 ...
 * @see https://jag-ui.com/theme-spec#theme-scales
 */
...
export interface Theme {
   ...
   *
   * References: https://jag-ui.com/color-modes/#turn-off-custom-properties
   */
   ...
   *
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/grid#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/button#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/text#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/link#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/image#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/card#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/container#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/label#variants
   * @see https://jag-ui.com/components/input#variants
   * @see https://jag-ui.com/components/select#variants
   * @see https://jag-ui.com/components/textarea#variants
   * @see https://jag-ui.com/components/radio#variants
   * @see https://jag-ui.com/components/checkbox#variants
   * @see https://jag-ui.com/components/slider#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/badge#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/alert#variants
   */
   ...
   * @see https://jag-ui.com/theme-spec#variants
   * @see https://jag-ui.com/components/variants
   * @see https://jag-ui.com/components/message#variants
   */
